...
//		}
	...
	public void newApple() {
		int randomX = random.nextInt(SCREEN_WIDTH / UNIT_SIZE) * UNIT_SIZE;
		int randomY = random.nextInt(SCREEN_HEIGTH / UNIT_SIZE) * UNIT_SIZE;
		appleX = randomX;
		appleY = randomY;
	...
	//check if head touches bottem boarder
